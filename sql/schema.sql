...
CREATE DATABASE IF NOT EXISTS sirgdi
...
-- Bitácora de avances del técnico durante la intervención. A diferencia del
-- comentario interno, estos avances se muestran al reportante en el seguimiento
-- público. (El modelo la crea con IF NOT EXISTS si falta en una base ya desplegada.)
